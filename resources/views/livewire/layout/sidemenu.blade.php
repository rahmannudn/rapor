        ...
        <div class="h-full px-3 pb-4 overflow-y-auto text-gray-900 bg-white rounded-lg dark:bg-gray-800 dark:text-white">
            <ul class="space-y-2 font-medium">
                ...
                @can('superAdminOrAdmin', auth()->user())
                    ...
                    <li>
                        <a href="{{ route('prestasiIndex') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->is('prestasiIndex') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <ul x-show="dropdownInputanMapel" class="py-2 space-y-2" x-transition>
                            <li>
                                <a href="{{ route('lingkupMateriIndex') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('lingkupMateriIndex') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    <span class="ms-3">Lingkup Materi</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('tujuanPembelajaranIndex') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('tujuanPembelajaranIndex') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    <span class="ms-3">Tujuan Pembelajaran</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('nilaiSumatifIndex') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('nilaiSumatifIndex') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    <span class="ms-3">Nilai Sumatif</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('nilaiFormatifIndex') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('nilaiFormatifIndex') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                ...
                <li x-data="{ dropdownLaporan: false }">
                    ...
                    <ul x-show="dropdownLaporan" class="py-2 space-y-2" x-transition>
                        ...
                        @can('isKepsekOrWaliKelas', auth()->user())
                            ...
                            <li>
                                <a href="{{ route('laporanAbsensi') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('laporanAbsensi') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    <span class="ms-3">Laporan Absensi</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('laporanProyek') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('laporanProyek') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    <span class="ms-3">Laporan Proyek</span>
                                </a>
                            </li>
                        @endcan
                    </ul>

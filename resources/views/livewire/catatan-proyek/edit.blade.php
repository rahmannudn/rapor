<div>
    ...
    <h1 class="mb-3 text-2xl font-bold text-slate-700 dark:text-white">Edit Catatan Proyek</h1>
                                ...
                                @foreach ($data['catatan_proyek'] as $catatanIndex => $catatan)
                                    <td class="px-4 py-4 border-l border-r dark:bg-gray-800 dark:border-gray-700"
                                        ...
                                        <x-textarea x-ref="catatanValue"
                                            ...
                                            wire:key="{{ $catatan['proyek_id'] }}" class="text-black"
                                            {{-- mengecek apakah text area ini tidak kosong, jika ya panggil fungsi update pada livewire --}} x-on:blur="checkAndUpdate" />
                                    </td>
                                @endforeach
                            </tr>
                        @empty
